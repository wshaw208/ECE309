	...
	public static void main(String[] args)
	{
		...
		catch(Exception e)
		{
			System.out.println("The Chat Room Server is not responding."
					...
					+ newLine + "or the ChatServer program is not accpeting connections at port 6666.");
			return; // terminate
		}
		...
		try
		{
			...
			PictureChatClientGUI pccg = new PictureChatClientGUI(username, oos); // load GUI
			...
			try
			{
				while(true) // Receiving Loop
				{
					...
					else if(messageFromServer instanceof Object[])
					{
					...
					else if(messageFromServer instanceof ImageIcon)
					{
						...
						System.out.println(receivedPicture.getDescription());
